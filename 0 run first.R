...
# Package names
packages <- c("remotes", "tidyverse", "reshape2", "data.table", "DBI", "mfdb", "gadget3", "gadgetutils", "cowplot", "fishmethods", "ggFishPlots", "Rgadget")
...
if (any(installed_packages == FALSE)) {
  ...
  if("gadgetutils" %in% packages[!installed_packages]) {
    remotes::install_github("gadget-framework/gadgetutils", upgrade = "never")
  }
