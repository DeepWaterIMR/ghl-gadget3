...
## Example data
load("/Users/a22357/ownCloud/GadgetGhl/g3 runs/model_files_20220930/data/Fitted and optimized TMB model.rda")
```
...
```{r}
ggplotly(plot_biomass(fit, total = TRUE) + 
           scale_color_manual(
             values = c("ghl_female_imm" = "tomato1", 
                        "ghl_female_mat" = "tomato4", 
                        "ghl_male_imm" = "dodgerblue1", 
